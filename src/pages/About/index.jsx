...
const About = () => {
    return (
        <main> 
            <div className="m-auto py-16 px-8 space-y-6 tracking-wider leading-8 xl:px-20">
            ...
            <div className="m-auto py-16 px-8 space-y-6 mb-10 tracking-wider leading-8 xl:px-20">
