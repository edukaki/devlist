  ...
  return (
    <>
      <div className="flex flex-row justify-between items-center gap-6 w-full px-3 mt-10 md:mt-0 md:px-6 bg-slate-400">
        <button
          className="flex flex-row justify-end items-center gap-6 text-slate-100 font-bold"
          onClick={() => setBtnAdd(!btnAdd)}
        >
          <div className="relative">
            <div className="w-5 h-1 rounded bg-slate-100" />
            <div
              className={`absolute top-0 w-5 h-1 rounded bg-slate-100 transition-all duration-500 ease-in-out ${
