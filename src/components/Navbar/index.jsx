...
const Navbar = () => {
    ...
    return (
        ...
        <nav className="z-50 bg-white border-gray-200 px-2 w-full fixed sm:px-4 py-2.5 rounded font-courier">
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                ...
                {!user ?
                    ...
                    <div className="flex items-center md:order-2">
                        ...
                        <div className={`${avatarMenu ? '' : 'hidden'} z-50 flex flex-col absolute justify-between w-full top-11 left-0 my-4 list-none bg-white divide-y divide-gray-100 rounded`} id="user-dropdown">
                            <ul className="py-1 text-lg text-gray-700 font-bold">
                                <li>
                                    <Link to={
                                        !user ? '/signin' :
